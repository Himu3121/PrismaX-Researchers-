...
export default function PrismaNavigator() {
  ...
  const translations = {
    bn: {
      ...
      whitepaperTopics: [
        { id: 1, title: "Physical AI কী?", summary: "রোবটের শরীর নিয়ন্ত্রণকারী বিশেষ কৃত্রিম বুদ্ধিমত্তা।", details: "Physical AI বাস্তব জগতের ফিজিক্যাল রোবট নিয়ন্ত্রণ করতে সক্ষম। এটি রোবটকে মানুষের মতো পরিবেশ বুঝতে এবং নড়াচড়া করতে শেখায়।\n\nউদাহরণ: আপনি ChatGPT-কে বললে সে আপনাকে কফি বানানোর রেসিপি লিখে দেবে, কিন্তু PrismaX-এর Physical AI রোবটকে নির্দেশ দিয়ে সত্যি সত্যি কফি বানিয়ে দিতে সক্ষম।" },
        ...
        { id: 3, title: "ডাটা গ্যাপ (The Data Gap)", summary: "রোবটকে বুদ্ধিমান বানানোর জন্য বাস্তব ডাটার অভাব দূর করা।", details: "রোবটকে শেখানোর জন্য ইন্টারনেটে পর্যাপ্ত 'বাস্তব ডাটা' নেই। মানুষের হাঁটার ভিডিও অনেক থাকলেও রোবটের হাঁটার সময় জয়েন্টের প্রেসারের ডাটা PrismaX তৈরি করে।" },
        ...
        { id: 5, title: "DePIN ও রোবটিক্স", summary: "বিকেন্দ্রীভূত ফিজিক্যাল ইনফ্রাস্ট্রাকচার নেটওয়ার্ক।", details: "বিশ্বের মানুষ তাদের ডাটা শেয়ার করে একটি বিশাল নেটওয়ার্ক তৈরি করে।" },
        { id: 6, title: "VLA মডেল", summary: "রোবটের দেখা, মানুষের ভাষা বোঝা এবং কাজ করার ক্ষমতা।", details: "VLA হলো রোবটের একটি শক্তিশালী মাল্টিমোডাল ব্রেইন।" },
        { id: 7, title: "হাই-ফিডেলিটি ডাটা", summary: "অত্যন্ত সূক্ষ্ম এবং হাই-কোয়ালিটি সেন্সর তথ্য।", details: "এতে রোবটের প্রতিটি মোটরের ভোল্টেজ এবং চাপের নিখুঁত হিসাব থাকে।" },
        ...
        { id: 9, title: "হার্ডওয়্যার অ্যাগনস্টিক", summary: "যেকোনো ধরণের রোবটে PrismaX ব্যবহারের সুবিধা।", details: "যেকোনো ব্র্যান্ডের রোবটিক হার্ডওয়্যার কন্ট্রোল করার সুবিধা।" },
        { id: 10, title: "Optimum Network", summary: "রিয়েল-টাইম অপারেশনের লো-লেটেন্সি নেটওয়ার্ক।", details: "নির্দেশ যেন মিলিসেকেন্ডের মধ্যে রোবটের কাছে পৌঁছায়।" },
        { id: 11, title: "RLNC টেকনোলজি", summary: "দুর্বল ইন্টারনেটেও শক্তিশালী ডাটা ট্রান্সমিশন।", details: "সিগন্যাল দুর্বল হলেও ডাটা হারিয়ে যেতে দেয় না।" },
        { id: 12, title: "ডাটা মাইনিং ২.০", summary: "কাজের মাধ্যমে রিওয়ার্ড অর্জন।", details: "রোবট ট্রেনিং-এর বিনিময়ে আপনি রিওয়ার্ড পাবেন।" },
        { id: 13, title: "প্রাইভেসি ও ডাটা এনক্রিপশন", summary: "ব্যবহারকারীর নিরাপত্তা এবং গোপনীয়তা রক্ষা।", details: "ডাটাগুলো এনক্রিপ্ট করে সেভ করা হয় যাতে গোপনীয়তা বজায় থাকে।" },
        { id: 14, title: "ফাউন্ডেশন মডেল", summary: "সব রোবটের জন্য একটি সাধারণ মস্তিস্ক।", details: "একবার একটি রোবট কিছু শিখলে সব রোবট তা শিখে যাবে।" },
        { id: 15, title: "কোঅর্ডিনেশন লেয়ার", summary: "মানুষের নির্দেশ ও রোবটের মোটরের সমন্বয়।", details: "মানুষের কমান্ড রোবটের জয়েন্ট নির্ভুলভাবে পালন করছে কি না তা নিশ্চিত করে।" },
        { id: 16, title: "PoUW", summary: "অপ্রয়োজনীয় বিদ্যুৎ নষ্ট না করে কার্যকর কাজ।", details: "রোবট ট্রেনিং এর মাধ্যমে কার্যকর কাজ সম্পন্ন করা।" },
        { id: 17, title: "হিউম্যান-ইন-দ্য-লুপ (HITL)", summary: "AI-এর সব কাজে মানুষের তদারকি।", details: "AI ভুল করলে মানুষ তাকে থামিয়ে সঠিক পথ দেখাতে পারবে।" },
        { id: 18, title: "ডিসেন্ট্রালাইজড নোড", summary: "সার্ভারের কোনো নির্দিষ্ট কেন্দ্র না থাকা।", details: "পুরো সিস্টেমটি সারা পৃথিবীতে ছড়িয়ে থাকা নোডে চলে।" },
        { id: 19, title: "স্কেলেবল ইন্টেলিজেন্স", summary: "কমিউনিটির সাথে বুদ্ধিমত্তা বৃদ্ধির হার।", details: "যত বেশি ইউজার যুক্ত হবে, AI তত দ্রুত বুদ্ধিমান হবে।" },
        { id: 20, title: "সিকার কমিউনিটি", summary: "ব্যবহারকারীদের হাতেই প্রজেক্টের ভবিষ্যৎ সিদ্ধান্ত।", details: "ভোটের মাধ্যমে প্রজেক্টের পরবর্তী পলিসি নির্ধারণ করা হবে।" }
      ]
    },
    en: {
      ...
      protocolDetails: [
        { id: 'p1', title: "Coordination Layer", summary: "Synchronization between human intent and robotic execution.", details: "The nerve center ensuring commands reach robotic joints accurately." },
      ...
      whitepaperTopics: [
        { id: 1, title: "Physical AI?", summary: "AI specifically designed to control robotic bodies.", details: "AI that understands the physical world." },
        { id: 2, title: "Teleoperation", summary: "Remote method of teaching robots.", details: "Teaching robots via VR and remote systems." },
        { id: 3, title: "The Data Gap", summary: "Bridging the lack of real robotic data.", details: "Creating the physical data missing from the internet." },
        { id: 4, title: "Data Flywheel", summary: "Self-improving AI development cycle.", details: "The more data, the better the AI becomes." },
        ...
        { id: 7, title: "High-Fidelity Data", summary: "Precise sensor information.", details: "Detailed motor and pressure data." },
        ...
        { id: 10, title: "Optimum Network", summary: "Low-latency network for robots.", details: "Millisecond response times for operations." },
        { id: 11, title: "RLNC Technology", summary: "Robust data transmission.", details: "Prevents data loss on weak connections." },
        ...
        { id: 16, title: "PoUW (Useful Work)", summary: "Effective energy usage.", details: "Training robots instead of solving puzzles." },
        { id: 17, title: "Human-in-the-Loop", summary: "Supervision over AI control.", details: "Ensuring human safety and AI oversight." },
        ...
        { id: 20, title: "Seeker Community", summary: "User-driven governance.", details: "Project direction decided by votes." }
      ]
    }
  };
  ...
  return (
    <div className="min-h-screen bg-transparent selection:bg-[#DFD8D0]/20 font-sans">
      ...
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-40 border-b border-white/5 backdrop-blur-xl px-8 py-5 flex justify-between items-center">
        ...
        <div className="flex items-center gap-10">
          <div className="hidden md:flex gap-8 text-[10px] font-black uppercase tracking-[0.2em] text-[#DFD8D0]/60">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-[#0d0d0d] rounded-full hover:bg-[#DFD8D0] hover:text-black transition-all text-[11px] font-bold uppercase tracking-widest text-white border border-white/20"
          >
            <Globe size={14} />
            {current.nav.langBtn}
          </button>
      ...
      <main className="max-w-6xl mx-auto px-6">
        ...
        {/* HERO SECTION - Fixed Spacing & Seekers Text */}
        <section id="hero" className="pt-52 pb-32 text-center">
          <motion.div key={lang} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <span className="text-[#DFD8D0] text-xs font-bold tracking-[0.5em] uppercase mb-6 block opacity-60">
              {current.hero.label}
            </span>
            <h2 className="text-6xl md:text-[8.5rem] font-serif text-white tracking-tighter leading-[0.85] mb-12">
              ...
              <span className="text-3xl md:text-4xl font-sans font-light tracking-tight text-[#DFD8D0]/40 block mt-6 uppercase">
                {current.hero.sub}
              </span>
            </h2>
          </motion.div>
        ...
        {/* RESEARCH EXPLORER - Double Part Layout */}
        <section id="whitepaper" className="py-32 border-t border-white/5">
          <h3 className="text-5xl md:text-7xl font-serif text-white italic mb-20 tracking-tighter">
            {current.nav.research} Explorer
          </h3>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6">
            {current.whitepaperTopics.map((topic) => (
              <motion.div 
                ...
                className="p-8 rounded-[40px] glass-card transition-all cursor-pointer group flex justify-between items-center"
              >
                <div className="flex gap-6 items-center">
                  <span className="text-[#DFD8D0] font-serif text-2xl opacity-10 group-hover:opacity-100 transition italic">
                    {topic.id < 10 ? `0${topic.id}` : topic.id}
                  </span>
                  <div>
                    <h4 className="text-xl font-serif text-white mb-1 italic tracking-tight">{topic.title}</h4>
                    <p className="text-[#DFD8D0]/50 text-[9px] uppercase tracking-widest">{topic.summary}</p>
                  </div>
                </div>
                <ChevronRight size={16} className="text-white/20 group-hover:text-[#DFD8D0]" />
              </motion.div>
            ))}
          </div>
        </section>
        ...
        {selectedTopic && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/95 backdrop-blur-2xl">
            ...
            <motion.div initial={{ scale: 0.95, opacity: 0, y: 50 }} animate={{ scale: 1, opacity: 1, y: 0 }} exit={{ scale: 0.95, opacity: 0, y: 50 }} className="relative bg-[#0d0d0d] border border-white/10 p-12 md:p-20 rounded-[60px] max-w-4xl w-full shadow-2xl overflow-y-auto max-h-[85vh] scrollbar-hide">
              ...
              <h3 className="text-4xl md:text-6xl font-serif text-white mb-10 italic leading-[1.1] tracking-tighter">{selectedTopic.title}</h3>
              <div className="space-y-10">
                ...
                <p className="text-[#DFD8D0]/70 text-lg leading-[1.8] font-light whitespace-pre-line">{selectedTopic.details}</p>
              </div>
            </motion.div>
          </div>
        )}
...
function ProtocolCard({ icon, title, desc }: any) {
  return (
    <div className="p-10 rounded-[45px] glass-card group transition-all h-full">
      <div className="w-14 h-14 bg-white/5 rounded-2xl flex items-center justify-center mb-6 text-[#DFD8D0] group-hover:bg-[#DFD8D0] group-hover:text-black transition">{icon}</div>
      <h4 className="text-xl font-serif text-white mb-3 italic tracking-tight">{title}</h4>
      <p className="text-[#DFD8D0]/40 text-xs leading-relaxed font-light">{desc}</p>
    </div>
  );
}